      ...
      <div className="mx-auto max-w-site px-5 sm:px-8">
        <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-lg md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">3. User Responsibilities</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Intellectual Property</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Service Level Agreement</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Confidentiality</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">9. Warranty Disclaimer</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">12. Governing Law</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">13. Changes to Terms</h2>
              <p className="text-gray-700">
